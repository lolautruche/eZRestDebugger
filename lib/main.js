...
$(document).ready(function() {
  ...
  // Store input value
  $('input.inputText, textarea.inputText').focusout(function() {
    if (rest.remember)
    {
  ...
  $('input[name="method"]').click(function() {
    ...
    if(rest.remember)
    {
      rest.storage.setValue('restMethod', method);
    }
    
    if(method === 'post') // POST method => show textarea to edit post params
    {
      $('#postParamsContainer').show();
    }
    else
    {
      $('#postParamsContainer').hide();
    }
  });
